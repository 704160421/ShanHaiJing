(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_6758f94baa12b7a825050bfe")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '6602293dfa595bcd33012f02';
_mrmcp['creative_id'] = '6758f94baa12b7a825050bfe';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '山海异兽';
_mrmcp['build_number'] = parseInt('427');
_mrmcp['publish_time'] = 'Sun Jun 15 2025 14:43:50 GMT+0800 (China Standard Time)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['stat_host'] = 'https://6758f94baa12b7a825050bfe.stat.mugeda.com/stats/c.gif';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.4.27';
...
if(!window['_mrmcp']['loader']){
    var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['bar']({
        'loadInfo': {"textLoading":0,"messageText":"加载中.....","messageSize":12,"messageColor":"#FFF","progressColor":"#F36523","progressBackground":"#FFF","backgroundColor":"rgba(221, 203, 161, 255)","logoImage":(Array.isArray(_mrmcp.creative_path) ? _mrmcp.creative_path[0] : _mrmcp.creative_path ) + "images/678025706e61594aec0ead6d.png","progressPosition":"20","logoWidth":"100","style":"bar"},
        'thisAni': {
            'dom': null,
            'width': 320
        },
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1749969830079", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1749969830079" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
    ...
    if(_mrmcp['render_mode']!='embedded'&&_mrmcp['render_mode']!='inline'){
        ...
        document.body.style.backgroundColor='rgba(214, 168, 107, 1)';
